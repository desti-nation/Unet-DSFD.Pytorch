...
# dataset config
_C.HOME = '/home/lb/lb/DSFD.Unet.pytorch/'


# face config
_C.FACE = EasyDict()
_C.FACE.TRAIN_FILE = '/home/lb/lb/DSFD.Unet.pytorch/train_list.txt'
_C.FACE.VAL_FILE = '/home/lb/lb/DSFD.Unet.pytorch/val_list.txt'
